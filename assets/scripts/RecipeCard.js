...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		// Build star‑rating snippet (show “No reviews” if rating missing)
		const ratingHTML = data.rating
		  ...
		  `
		  : `<div class="rating"><span>No reviews</span></div>`;
	
		// Inject the card’s markup (everything *inside* <article>)
		article.innerHTML = `
		  <img src="${data.imgSrc}" alt="${data.imgAlt}">
		  <p class="title">
			<a href="${data.titleLnk}" target="_blank" rel="noopener">${data.titleTxt}</a>
		  </p>
